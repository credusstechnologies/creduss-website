...
const About = () => {
  return (
    <Layout heroBg={"/icons/about-bg.png"}>
      ...
      <section className="md:flex md:items-center md:flex-row-reverse md:justify-between gap-20 px-[15.5px] md:px-0 md:pl-20 mt-7 md:mt-0">
